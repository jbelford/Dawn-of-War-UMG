...
namespace DowUmg.Presentation.ViewModels
{
    ...
    {
        public ProportionalOptionsViewModel(
            string name,
        ...
        )
        {
            ...
            {
                Items.Add(
                    new NumberInputViewModel<T>(100)
                    {
                        Label = toString.Invoke(option),
                        Item = option
                    }
                );
            }
        ...
        public ObservableCollection<NumberInputViewModel<T>> Items { get; } =
            new ObservableCollection<NumberInputViewModel<T>>();
    }
